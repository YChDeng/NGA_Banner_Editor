 ...
 *@param x x坐标或event
 *@param y y坐标
 *@param z 1 设置o最大宽度  2 设置o的宽度为最大宽度 4设置为100%宽度和高度(不留空间) 8不留4px鼠标指针偏移 16自动宽度 32返回坐标不设置位置 64相对鼠标x居中
 */
...
if( document.characterSet.toUpperCase()=='UTF-8' && typeof(a.u)=='object' && a.u.a){
	if(typeof(a.u.a['__inchst'])=='undefined'){
		a.u.a['__inchst']='UTF-8'
		console.log('auto set __inchst to utf-8')
		}
	}
